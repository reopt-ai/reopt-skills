...
- **Session replay** — configuration unsupported by the installed version; replay included in default-granted consent; missing separate visitor decision; bypassed masks/blocks; public asset manifests containing visitor uploads, avatars or personalized files; recorder bodies or upload grants logged; no consent-revocation/reset test. Use the installed client README as the contract.
